...
const SignUp = () => {
  ...
  return (
    <div className="mt-8 flex justify-center items-center bg-cover bg-center bg-no-repeat " style={{ backgroundImage: `url(${image})` }}>
      <div className="w-1/2">
        <img src="https://i.ibb.co/wyc4BgD/login-animate.gif" alt="" />
      </div>

      <div className="w-full max-w-md p-8 space-y-3 shadow-xl mx-auto my-5 rounded-xl ">
      <div className="flex -my-10">
        <div className="mx-auto h-40 w-40">
        <img src="https://i.ibb.co/6bShK8p/output-onlinegiftools.gif" alt="" />
       ...
       <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <input
              type="text"
              className="input input-bordered my-3 input-warning w-full  "
            ...
            <input
              ...
              {...register("password", { required: "Please Set The Email" })}
              className="input input-bordered my-3 input-warning w-full"
            />
