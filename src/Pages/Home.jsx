  ...
  return (
    <div className=" py-6">
      ...
      <div>
        <section className="">
          <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
            <Zoom>
              <div>
                <h2 className="text-3xl font-bold tracki text-center sm:text-5xl font-link">
                  Shopping Your Dream!
                </h2>
            ...
            <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                    ...
                    <div className="flex">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="mt-2 ">
                          ...
                          within 30 days.Designed and sold by Hafeez Center in
                          the United States.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="mt-2 ">
                          ...
                          Promise Ring for Her. Gifts to spoil your love more
                          for Engagement, Wedding, Anniversary.
                        </p>
                      </div>
                    </div>
                  </Zoom>
              ...
              <Fade direction="right">
                <div aria-hidden="true" className="mt-10 lg:mt-0">
                  <img
                    src="https://i.ibb.co/bWKKSFJ/pexels-photo-5935741.jpg"
                    alt=""
                    className="mx-auto h-[70vh] rounded-lg shadow-lg dark:bg-gray-500"
                  />
                </div>
              </Fade>
            </div>
            <div>
              <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                ...
                <div className="mt-10 lg:mt-0 lg:col-start-1 lg:row-start-1">
                  <Fade direction="left">
                    <img
                      src="https://i.ibb.co/M7p9ht4/pexels-photo-6214155.jpg"
                      alt=""
                      className="mx-auto h-[70vh] rounded-lg shadow-lg dark:bg-gray-500"
                    />
                  </Fade>
      ...
      <section className="background">
        <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
          <div className="flex items-center justify-center p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
            <Fade direction="left">
              <img
                src="https://i.ibb.co/D5f7gf7/pexels-photo-5872364.webp"
                alt=""
          ...
          <div className="flex flex-col justify-center p-4 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
            <Zoom>
              <h1 className="text-4xl font-bold leadi sm:text-6xl font-link">
                Return or
                <span className="text-error"> exchange </span>any order
                available!
              </h1>
            </Zoom>
            <Zoom>
            ...
            <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
              <Zoom>
                <Link
                  to={"/men"}
                  className="btn btn-outline btn-error rounded  font-link text-white"
                >
                  Shop Men
                </Link>
                <Link
                  to={"/women"}
                  className="btn btn-outline rounded  btn-error font-link text-white"
                >
                  Shop Women
                </Link>
              </Zoom>
      ...
      <section>
        ...
        <Zoom>
          <img
            src="https://i.ibb.co/86MH5YT/pexels-photo-221387.jpg"
            alt=""
